...
async def root():
    ...
    return {
        "name": "geminicli2api",
        "description": "Multi-API proxy for Google's Gemini models via gemini-cli",
        "purpose": "Provides OpenAI-compatible, Claude-compatible, and native Gemini API endpoints for accessing Google's Gemini models",
        "version": "1.0.0",
        "endpoints": {
            "openai_compatible": {
